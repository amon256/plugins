...
public class InstallAuto {
	...
	private static final String ARG_HOME = "install_file";//安装源文件
	private static final String ARG_TARGET = "install_target";//应用位置
	...
	public static void install(String installHome,String installTarget,String installConfig,Map<String,String> otherArgs) throws Exception{
		logger.info("installFrom:{}\ninstallTo:{}\nconfigFile:{}",installHome,installTarget,installConfig);
